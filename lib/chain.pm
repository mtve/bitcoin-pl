...

{
	...
	*$_ = \&{"chain::$cfg::var{CHAIN}::$_"}	for qw(
		GenesisBlock
	);
	*$_ = \${"chain::$cfg::var{CHAIN}::$_"}	for qw(
		GenesisHash WIRE_MAGIC ADDRESS_PUBKEY ADDRESS_SCRIPT
	);
}
...
our $ADDRESS_PUBKEY = 0;
our $ADDRESS_SCRIPT = 5;
...
our $ADDRESS_PUBKEY = 111;
our $ADDRESS_SCRIPT = 196;
our $GenesisHash = $util::h2b{
